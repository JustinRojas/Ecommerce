...
namespace Ecommerce.Servicio.Implementacion
{
    public class CategoriaServicio : ICategoriaServicio
    {
        ...
        public async Task<bool> Editar(CategoriaDTO modelo)
        {
            try
            {
                var consulta = _modeloRepositorio.Get(p => p.IdCategoria == modelo.IdCategoria);
        ...
        public async Task<List<CategoriaDTO>> Lista( string buscar)
        {
            try
            {
                var consulta = _modeloRepositorio.Get(p =>  string.Concat(p.Nombre.ToLower()).Contains(buscar.ToLower()));
